    ...
    <div>
      <div className="flex justify-center m-4">
        ...
        <label className="input input-bordered flex items-center gap-2">
            ...
            <input type="text" className="grow" defaultValue={user.displayName}  name="userName" required/>
          </label>
          <label className="input input-bordered flex items-center gap-2">
            <svg
              xmlns="http://www.w3.org/2000/svg"
            ...
            <input type="email" className="grow " defaultValue={user.email} name="email" required />
          </label>
          <textarea
